...
optparser.add_option(
    "-s", "--tag_scheme", default="iob", # "iobes"
...
optparser.add_option(
    "-L", "--lr_method", default="adam", # "sgd-lr_.005",
...
optparser.add_option(
    "-P", "--path_to_tagger", default="~/Desktop/tagger",
    help="path to tagger directory"
)
...
parameters['n_epochs'] = opts.n_epochs
...
if not os.path.isfile(eval_script):
    # eval_script = "~/Desktop/tagger/evaluation/conlleval"
...
# Initialize model
model = Model(opts.model_loc, parameters=parameters, models_path=models_path)
...
n_epochs = opts.n_epochs  # number of epochs over the training set
