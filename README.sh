...
### MAKE SURE THAT ALL YOUR FILE NAMES ONLY USE ASCII CHARACTERS AND _ OR -, NO ACCENTS, SPACES, PARENTHESIS, DIACRITICS, ETC.. THESE ARE OF COURSE FINE WITHIN THE FILES, THOUGH NOT AS A FILENAME
